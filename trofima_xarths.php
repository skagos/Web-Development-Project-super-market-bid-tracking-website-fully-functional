...
$location = (new Map) ->showTrofima();
foreach($location as $key => $value){
  $name = $value["name"];
  $longitude= $value["longitude"];
  $latitude = $value["latitude"];
  echo "<script> var marker = L.marker([$latitude ,$longitude],{icon: greenIcon}).addTo(mymap).bindPopup('$name'+'<button> Αξιολόγηση</button>' )</script>";
